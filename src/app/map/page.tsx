    ...
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900">
      <main className="flex-1 flex flex-col max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
            ...
            <div className="flex lg:hidden bg-slate-200/80 p-1 rounded-2xl w-full sm:w-auto shadow-2xs">
              <button
                ...
                className={`flex-1 sm:flex-initial flex items-center justify-center gap-2 py-2 px-4 rounded-xl text-xs font-bold transition-all ${mobileView === "map"
              ...
              <button
                ...
                className={`flex-1 sm:flex-initial flex items-center justify-center gap-2 py-2 px-4 rounded-xl text-xs font-bold transition-all ${mobileView === "list"
                    ? "bg-white text-emerald-700 shadow-soft"
                    : "text-slate-600 hover:text-slate-900"
                  }`}
              >
                ...
                <div className="flex items-center gap-1">
                  {[
                    ...
                    <button
                      ...
                      className={`px-2.5 py-1 rounded-lg text-xs font-semibold transition-all cursor-pointer ${selectedGender === g.id
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 min-h-[580px]">
          ...
          <div
            className={`lg:col-span-5 flex-col ${mobileView === "list" ? "flex" : "hidden lg:flex"
              }`}
          >
                      ...
                      <div className="flex gap-3.5">
                        ...
                        <div className="relative w-28 h-28 shrink-0 rounded-xl overflow-hidden bg-slate-100">
                          ...
                          <div className="absolute top-1.5 left-1.5">
                            <span
                              className={`text-[9px] font-bold px-1.5 py-0.5 rounded uppercase shadow-sm ${property.gender_type === "PUTRI"
          ...
          <div
            className={`lg:col-span-7 h-[500px] sm:h-[580px] lg:h-auto ${mobileView === "map" ? "flex" : "hidden lg:flex"
              }`}
          >
            <MapViewer
